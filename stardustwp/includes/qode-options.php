...
$qode_options_stardust  = get_option('qode_options_stardust');
...
class Qode_Theme_Options {
	...
	function init_qode_theme_options() {
		global $qode_options_stardust;
		if(isset($qode_options_stardust['reset_to_defaults'])){ 
			if( $qode_options_stardust['reset_to_defaults'] == 'yes' ) delete_option( "qode_options_stardust");
		}
		if (! get_option("qode_options_stardust")) {
			add_option( "qode_options_stardust",
				array( // intitialize the 'qode_options_stardust' array with the following key => value pairs:
					"reset_to_defaults" => '',
					"number_of_chars" => 45,
					"first_color" => '',
					"second_color" => '',
					...
					"portfolio_single_h1_color" => '',
					"portfolio_single_h1_google_fonts" => '-1',
					"portfolio_single_h1_fontsize" => '',
					"portfolio_single_h1_lineheight" => '',
					"portfolio_single_h1_fontstyle" => '',
					"portfolio_single_h1_fontweight" => '',
					"portfolio_open_single_on_portfolio_page" => 'yes',
					...
					"contact_heading_subtitle_above" => '',
	...
	function register_qode_theme_settings() {
	    register_setting( 'qode_options_stardust_page', 'qode_options_stardust', array(&$this, 'validate_options') );
	    // register_setting( 'qode_options_stardust_page', array(&$this, 'another_of_my_options') );
	}
	//extend the admin menu
	function qode_admin_menu() {
		$this->init_qode_theme_options();
		//Add the Qode options page to the Themes' menu
		$this->pagehook = add_menu_page('Qode Theme', esc_html__('Qode', 'qode'), 'manage_options', 'qode_options_stardust_page', array(&$this, 'qode_generate_options_page'));
	...
	function qode_generate_options_page() {
		...
		global $screen_layout_columns, $qode_options_stardust;
...
<?php			settings_fields( 'qode_options_stardust_page' ); // Checks that the user can update options and also redirect the user back to the correct admin page (this form).
			$options = get_option('qode_options_stardust');
...
<?php					    do_meta_boxes($this->pagehook, 'additional', $options); ?>
						...
						<label for="reset_to_defaults">
						    <input name="qode_options_stardust[reset_to_defaults]" type="checkbox" id="reset_to_defaults" value="yes" />
...
<?php	}
	...
	global $qode_options_stardust;
		$input['number_of_chars'] = is_numeric( $input['number_of_chars'] ) ? absint($input['number_of_chars']) : $qode_options_stardust['number_of_chars'];
		return $input;
	}
					...
					<tbody>
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_stardust[first_color]" type="text" value="<?php if ($options['first_color']) { echo esc_attr($options['first_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_stardust[second_color]" type="text" value="<?php if ($options['second_color']) { echo esc_attr($options['second_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_stardust[background_color]" type="text" value="<?php if ($options['background_color']) { echo esc_attr($options['background_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_stardust[background_color_box]" type="text" value="<?php if (isset($options['background_color_box'])) { echo esc_attr($options['background_color_box'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_stardust[highlight_color]" type="text"  value="<?php if ($options['highlight_color']) { echo esc_attr($options['highlight_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_stardust[selection_color]" type="text"  value="<?php if ($options['selection_color']) { echo esc_attr($options['selection_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_stardust[sidebar_background_color]" type="text"  value="<?php if ($options['sidebar_background_color']) { echo esc_attr($options['sidebar_background_color'], 'qode'); } ?>" size="30" maxlength="500" />
								</td>
						</tr>
						<tr valign="top">
							...
							<td>	
								...
								<input type="text" id="background_image" name="qode_options_stardust[background_image]" class="background_image" value="<?php if (isset($options['background_image'])) { echo esc_attr($options['background_image'], 'qode'); } ?>" size="70">
						...
						<tr valign="top">
							...
							<td>	
								<div class="inline" style="width: 600px;">
								<input type="text" id="pattern_background_image" name="qode_options_stardust[pattern_background_image]" class="pattern_background_image" value="<?php if (isset($options['pattern_background_image'])) { echo esc_attr($options['pattern_background_image'], 'qode'); } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								<br/>
								<?php esc_html_e('Only with boxed layout', 'qode'); ?>
								</div>
						...
						<tr valign="middle">
							...
							<td>	
								<div class="inline" style="width: 600px;">
								<input type="text" id="favicon_image" name="qode_options_stardust[favicon_image]" class="favicon_image" value="<?php if ($options['favicon_image']) { echo esc_attr($options['favicon_image'], 'qode'); } else { echo QODE_ROOT."/img/favicon.ico"; } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_stardust[google_fonts]">
						...
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_stardust[page_transitions]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[smooth_scroll]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[boxed]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[responsiveness]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[show_back_button]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_stardust[google_analytics_code]" type="text" value="<?php if (isset($options['google_analytics_code'])) { echo esc_attr($options['google_analytics_code'], 'qode'); } ?>" size="63" maxlength="500" />
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="internal_no_ajax_links" name="qode_options_stardust[internal_no_ajax_links]" cols="60" rows="5"><?php if (isset($options['internal_no_ajax_links'])) { echo esc_attr($options['internal_no_ajax_links'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_css" name="qode_options_stardust[custom_css]" cols="60" rows="5"><?php if ($options['custom_css']) { echo esc_attr($options['custom_css'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_js" name="qode_options_stardust[custom_js]" cols="60" rows="5"><?php if ($options['custom_js']) { echo esc_attr($options['custom_js'], 'qode'); } ?></textarea>
								</div><br/>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_keywords" name="qode_options_stardust[meta_keywords]" cols="60" rows="5"><?php if ($options['meta_keywords']) { echo esc_attr($options['meta_keywords'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_description" name="qode_options_stardust[meta_description]" cols="60" rows="5"><?php if ($options['meta_description']) { echo esc_attr($options['meta_description'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_stardust[disable_qode_seo]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h1_color]" type="text" value="<?php if ($options['h1_color']) { echo esc_attr($options['h1_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h1_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										...
										<input name="qode_options_stardust[h1_fontsize]" type="text" value="<?php if ($options['h1_fontsize']) { echo esc_attr($options['h1_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h1_lineheight]" type="text" value="<?php if ($options['h1_lineheight']) { echo esc_attr($options['h1_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h1_fontstyle]">
									...
									<div class="inline">
										...
										<select name="qode_options_stardust[h1_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h2_color]" type="text" value="<?php if ($options['h2_color']) { echo esc_attr($options['h2_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h2_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[h2_fontsize]" type="text" value="<?php if ($options['h2_fontsize']) { echo esc_attr($options['h2_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h2_lineheight]" type="text" value="<?php if ($options['h2_lineheight']) { echo esc_attr($options['h2_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h2_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[h2_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h3_color]" type="text" value="<?php if ($options['h3_color']) { echo esc_attr($options['h3_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h3_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[h3_fontsize]" type="text" value="<?php if ($options['h3_fontsize']) { echo esc_attr($options['h3_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h3_lineheight]" type="text" value="<?php if ($options['h3_lineheight']) { echo esc_attr($options['h3_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h3_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[h3_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h4_color]" type="text" value="<?php if ($options['h4_color']) { echo esc_attr($options['h4_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h4_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[h4_fontsize]" type="text" value="<?php if ($options['h4_fontsize']) { echo esc_attr($options['h4_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h4_lineheight]" type="text" value="<?php if ($options['h4_lineheight']) { echo esc_attr($options['h4_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h4_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[h4_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h5_color]" type="text" value="<?php if ($options['h5_color']) { echo esc_attr($options['h5_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h5_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[h5_fontsize]" type="text" value="<?php if ($options['h5_fontsize']) { echo esc_attr($options['h5_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h5_lineheight]" type="text" value="<?php if ($options['h5_lineheight']) { echo esc_attr($options['h5_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h5_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[h5_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[h6_color]" type="text" value="<?php if ($options['h6_color']) { echo esc_attr($options['h6_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[h6_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[h6_fontsize]" type="text" value="<?php if ($options['h6_fontsize']) { echo esc_attr($options['h6_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[h6_lineheight]" type="text" value="<?php if ($options['h6_lineheight']) { echo esc_attr($options['h6_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[h6_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[h6_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[text_color]" type="text" value="<?php if ($options['text_color']) { echo esc_attr($options['text_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_stardust[text_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[text_fontsize]" type="text" value="<?php if ($options['text_fontsize']) { echo esc_attr($options['text_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[text_lineheight]" type="text" value="<?php if ($options['text_lineheight']) { echo esc_attr($options['text_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[text_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[text_fontweight]">
									...
									<div class="inline">
										...
										<input name="qode_options_stardust[text_margin]" type="text" value="<?php if (isset($options['text_margin'])) { echo esc_attr($options['text_margin'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_stardust[link_color]" type="text" value="<?php if ($options['link_color']) { echo esc_attr($options['link_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										...
										<input name="qode_options_stardust[link_hovercolor]" type="text" value="<?php if ($options['link_hovercolor']) { echo esc_attr($options['link_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[link_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[link_fontweight]">
									...
									<div class="inline">
										...
										<select name="qode_options_stardust[link_fontdecoration]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[page_title_color]" type="text" value="<?php if ($options['page_title_color']) { echo esc_attr($options['page_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[page_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_stardust[page_title_fontsize]" type="text" value="<?php if ($options['page_title_fontsize']) { echo esc_attr($options['page_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_stardust[page_title_lineheight]" type="text" value="<?php if ($options['page_title_lineheight']) { echo esc_attr($options['page_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_stardust[page_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_stardust[page_title_fontweight]">
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[header_in_grid]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[header_widget_area]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[header_fixed]">
						...
						<tr>
							<td valign="middle" width="150"><?php esc_html_e('Fixed menu resize', 'qode'); ?></td>
							<td>
								<div class="inline">
									<select name="qode_options_stardust[fixed_menu_resize]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[header_background_color_initial]" type="text" value="<?php if ($options['header_background_color_initial']) { echo esc_attr($options['header_background_color_initial'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Transparency', 'qode'); ?>
									<input name="qode_options_stardust[header_background_color_initial_transparency]" type="text" value="<?php if (isset($options['header_background_color_initial_transparency'])) { echo esc_attr($options['header_background_color_initial_transparency'], 'qode'); } ?>" size="10" maxlength="10" />
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[header_background_color]" type="text" value="<?php if ($options['header_background_color']) { echo esc_attr($options['header_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Transparency', 'qode'); ?>
									<input name="qode_options_stardust[header_background_color_transparency]" type="text" value="<?php if (isset($options['header_background_color_transparency'])) { echo esc_attr($options['header_background_color_transparency'], 'qode'); } ?>" size="10" maxlength="10" />
									<?php esc_html_e('From 0 to 1', 'qode'); ?>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[header_background_color_mobile]" type="text" value="<?php if (isset($options['header_background_color_mobile']) &&  $options['header_background_color_mobile']) { echo esc_attr($options['header_background_color_mobile'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline" style="width: 600px;">
									...
									<input type="text" id="logo_image" name="qode_options_stardust[logo_image]" class="logo_image" value="<?php if ($options['logo_image']) { echo esc_attr($options['logo_image'], 'qode'); } else { echo QODE_ROOT."/img/logo.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[center_logo_image]">
						...
						<tr valign="top">
								...
								<td>
									<div class="inline">
										<select name="qode_options_stardust[top_menu]">
									...
									<div class="inline">
										...
										<input name="qode_options_stardust[dropdown_background_color]" type="text" value="<?php if (isset($options['dropdown_background_color'])) { echo esc_attr($options['dropdown_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[menu_color]" type="text" value="<?php if ($options['menu_color']) { echo esc_attr($options['menu_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_stardust[menu_hovercolor]" type="text" value="<?php if (isset($options['menu_hovercolor'])) { echo esc_attr($options['menu_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[menu_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_stardust[menu_fontsize]" type="text" value="<?php if ($options['menu_fontsize']) { echo esc_attr($options['menu_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_stardust[menu_lineheight]" type="text" value="<?php if ($options['menu_lineheight']) { echo esc_attr($options['menu_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_stardust[menu_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_stardust[menu_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_stardust[menu_letter_spacing]" type="text" value="<?php if (isset($options['menu_letter_spacing'])) { echo esc_attr($options['menu_letter_spacing'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[dropdown_color]" type="text" value="<?php if (isset($options['dropdown_color'])) { echo esc_attr($options['dropdown_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_stardust[dropdown_hovercolor]" type="text" value="<?php if (isset($options['dropdown_hovercolor'])) { echo esc_attr($options['dropdown_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[dropdown_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[dropdown_fontsize]" type="text" value="<?php if ($options['dropdown_fontsize']) { echo esc_attr($options['dropdown_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[dropdown_lineheight]" type="text" value="<?php if ($options['dropdown_lineheight']) { echo esc_attr($options['dropdown_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[dropdown_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[dropdown_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[dropdown_color_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_color_thirdlvl'])) { echo esc_attr($options['dropdown_color_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_stardust[dropdown_hovercolor_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_hovercolor_thirdlvl'])) { echo esc_attr($options['dropdown_hovercolor_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[dropdown_google_fonts_thirdlvl]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_stardust[dropdown_fontsize_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_fontsize_thirdlvl'])) { echo esc_attr($options['dropdown_fontsize_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_stardust[dropdown_lineheight_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_lineheight_thirdlvl'])) { echo esc_attr($options['dropdown_lineheight_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_stardust[dropdown_fontstyle_thirdlvl]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_stardust[dropdown_fontweight_thirdlvl]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_stardust[responsive_title_image]">
								...
								<div class="inline" style="width: 600px;">
									...
									<input type="text" id="title_image" name="qode_options_stardust[title_image]" class="title_image" value="<?php if (isset($options['title_image'])) { echo esc_attr($options['title_image'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Fixed title image', 'qode'); ?>
									<select name="qode_options_stardust[fixed_title_image]">
								...
								<div class="inline">
									...
									<input name="qode_options_stardust[title_height]" type="text" value="<?php if (isset($options['title_height'])) { echo esc_attr($options['title_height'], 'qode'); } ?>" size="10" maxlength="10" />
									<?php esc_html_e('Only if title image is not responsive', 'qode'); ?>
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Title position', 'qode'); ?>
									<select name="qode_options_stardust[page_title_position]">
								...
								<div class="inline">
									...
									<select name="qode_options_stardust[title_in_grid]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[footer_widget_area]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[footer_text]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[footer_top_title_color]" type="text" value="<?php if ($options['footer_top_title_color']) { echo esc_attr($options['footer_top_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_stardust[footer_top_text_color]" type="text" value="<?php if ($options['footer_top_text_color']) { echo esc_attr($options['footer_top_text_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									...
									<input name="qode_options_stardust[footer_top_background_color]" type="text" value="<?php if ($options['footer_top_background_color']) { echo esc_attr($options['footer_top_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[footer_bottom_text_color]" type="text" value="<?php if ($options['footer_bottom_text_color']) { echo esc_attr($options['footer_bottom_text_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									...
									<input name="qode_options_stardust[footer_bottom_background_color]" type="text" value="<?php if ($options['footer_bottom_background_color']) { echo esc_attr($options['footer_bottom_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
			...
			<div>
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							<td valign="middle"><?php esc_html_e('Separator', 'qode'); ?></td>
							<td>
								<div class="inline">
									<?php esc_html_e('Color', 'qode'); ?>
									...
									<input name="qode_options_stardust[separator_color]" type="text" value="<?php if (isset($options['separator_color'])) { echo esc_attr($options['separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Thickness (px)', 'qode'); ?>
									<input name="qode_options_stardust[separator_thickness]" type="text" value="<?php if ($options['separator_thickness']) { echo esc_attr($options['separator_thickness'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Top margin (px)', 'qode'); ?>
									<input name="qode_options_stardust[separator_topmargin]" type="text" value="<?php if ($options['separator_topmargin']) { echo esc_attr($options['separator_topmargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Bottom margin (px)', 'qode'); ?>
									<input name="qode_options_stardust[separator_bottommargin]" type="text" value="<?php if ($options['separator_bottommargin']) { echo esc_attr($options['separator_bottommargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[button_title_color]" type="text" value="<?php if ($options['button_title_color']) { echo esc_attr($options['button_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_stardust[button_title_hovercolor]" type="text" value="<?php if ($options['button_title_hovercolor']) { echo esc_attr($options['button_title_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[button_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_stardust[button_title_fontsize]" type="text" value="<?php if ($options['button_title_fontsize']) { echo esc_attr($options['button_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_stardust[button_title_lineheight]" type="text" value="<?php if ($options['button_title_lineheight']) { echo esc_attr($options['button_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_stardust[button_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_stardust[button_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_stardust[button_backgroundcolor]" type="text" value="<?php if ($options['button_backgroundcolor']) { echo esc_attr($options['button_backgroundcolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[message_title_color]" type="text" value="<?php if ($options['message_title_color']) { echo esc_attr($options['message_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[message_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_stardust[message_title_fontsize]" type="text" value="<?php if ($options['message_title_fontsize']) { echo esc_attr($options['message_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_stardust[message_title_lineheight]" type="text" value="<?php if ($options['message_title_lineheight']) { echo esc_attr($options['message_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_stardust[message_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_stardust[message_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_stardust[message_backgroundcolor]" type="text" class="colorpicker-input" value="<?php if ($options['message_backgroundcolor']) { echo esc_attr($options['message_backgroundcolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[blockquote_font_color]" type="text" value="<?php if ($options['blockquote_font_color']) { echo esc_attr($options['blockquote_font_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_stardust[parallax_speed]" type="text" value="<?php if ($options['parallax_speed']) { echo esc_attr($options['parallax_speed'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[parallax_onoff]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_stardust[parallax_minheight]" type="text" value="<?php if ($options['parallax_minheight']) { echo esc_attr($options['parallax_minheight'], 'qode'); } ?>" size="10" maxlength="10" />
				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_stardust[portfolio_background_color]" type="text" value="<?php if (isset($options['portfolio_background_color'])) { echo esc_attr($options['portfolio_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Portfolio single H1 style', 'qode'); ?></td>
							<td>
								<div class="inline">
									<?php esc_html_e('Color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['portfolio_single_h1_color']){ echo 'background-color:'.esc_attr($options['portfolio_single_h1_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_stardust[portfolio_single_h1_color]" type="text" value="<?php if(isset($options['portfolio_single_h1_color'])){ if ($options['portfolio_single_h1_color']) { echo esc_attr($options['portfolio_single_h1_color'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>	
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_stardust[portfolio_single_h1_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
											<option <?php if (isset($options['portfolio_single_h1_google_fonts']) && $options['portfolio_single_h1_google_fonts'] == str_replace(' ', '+', $fontArray["family"])) { echo "selected='selected'"; } ?>  value="<?php echo str_replace(' ', '+', $fontArray["family"]); ?>"><?php echo  $fontArray["family"]; ?></option>
										<?php } ?>
									</select>
								</div>
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_stardust[portfolio_single_h1_fontsize]" type="text" value="<?php if(isset($options['portfolio_single_h1_color'])){ if ($options['portfolio_single_h1_fontsize']) { echo esc_attr($options['portfolio_single_h1_fontsize'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>	
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_stardust[portfolio_single_h1_lineheight]" type="text" value="<?php if(isset($options['portfolio_single_h1_color'])){ if ($options['portfolio_single_h1_lineheight']) { echo esc_attr($options['portfolio_single_h1_lineheight'], 'qode'); } } ?>" size="10" maxlength="10" />
								</div>	
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_stardust[portfolio_single_h1_fontstyle]">
										<option <?php if (isset($options['portfolio_single_h1_fontstyle']) && $options['portfolio_single_h1_fontstyle'] == "") { echo "selected='selected'"; } ?> value=""></option>
										<option <?php if (isset($options['portfolio_single_h1_fontstyle']) && $options['portfolio_single_h1_fontstyle'] == "normal") { echo "selected='selected'"; } ?> value="normal">normal</option>
										<option <?php if (isset($options['portfolio_single_h1_fontstyle']) && $options['portfolio_single_h1_fontstyle'] == "italic") { echo "selected='selected'"; } ?> value="italic">italic</option>
										
									</select>
								</div>
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_stardust[portfolio_single_h1_fontweight]">
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "") { echo "selected='selected'"; } ?> value=""></option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "200") { echo "selected='selected'"; } ?> value="200">200</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "300") { echo "selected='selected'"; } ?> value="300">300</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "400") { echo "selected='selected'"; } ?> value="400">400</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "500") { echo "selected='selected'"; } ?> value="500">500</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "600") { echo "selected='selected'"; } ?> value="600">600</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "700") { echo "selected='selected'"; } ?> value="700">700</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "800") { echo "selected='selected'"; } ?> value="800">800</option>
										<option <?php if (isset($options['portfolio_single_h1_fontweight']) && $options['portfolio_single_h1_fontweight'] == "900") { echo "selected='selected'"; } ?> value="900">900</option>
									</select>
								</div>
							</td>
						</tr>
						<tr>
							<td scope="row" width="150"><?php esc_html_e('Open single portfolio on portfolio page', 'qode'); ?></td>
							<td>
								<div class="inline">
									<select name="qode_options_stardust[portfolio_open_single_on_portfolio_page]">
										<option <?php if (isset($options['portfolio_open_single_on_portfolio_page']) && $options['portfolio_open_single_on_portfolio_page'] == "yes") { echo "selected='selected'"; } ?> value="yes">Yes</option>
										<option <?php if (isset($options['portfolio_open_single_on_portfolio_page']) && $options['portfolio_open_single_on_portfolio_page'] == "no") { echo "selected='selected'"; } ?> value="no">No</option>
									</select>
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[portfolio_style]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[lightbox_single_project]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_stardust[portfolio_columns_number]">
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[pagination]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[blog_style]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[category_blog_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[blog_hide_comments]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_stardust[number_of_chars]" type="text" class="colorpicker-input" value="<?php if ($options['number_of_chars']) { echo esc_attr($options['number_of_chars'], 'qode'); } ?>" size="10" maxlength="10" />
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[blog_single_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_stardust[blog_single_sidebar_custom_display]">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<input name="qode_options_stardust[receive_mail]" type="text" value="<?php if ($options['receive_mail']) { echo esc_attr($options['receive_mail'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Contact Form', 'qode'); ?></td>
							<td>
								<select name="qode_options_stardust[enable_contact_form]">
						...
						<tr valign="top">
							...
							<td>
								<select name="qode_options_stardust[hide_contact_form_website]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_stardust[email_from]" type="text" value="<?php if ($options['email_from']) { echo esc_attr($options['email_from'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Email Subject', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[email_subject]" type="text" value="<?php if ($options['email_subject']) { echo esc_attr($options['email_subject'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Use reCaptcha', 'qode'); ?></td>
							<td>
								<select name="qode_options_stardust[use_recaptcha]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_stardust[recaptcha_public_key]" type="text" value="<?php if ($options['recaptcha_public_key']) { echo esc_attr($options['recaptcha_public_key'], 'qode'); } ?>"  />
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_stardust[recaptcha_private_key]" type="text" value="<?php if ($options['recaptcha_private_key']) { echo esc_attr($options['recaptcha_private_key'], 'qode'); } ?>"  />
							</td>
						</tr>			
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Heading above contact form', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[contact_heading_above]" type="text" value="<?php if ($options['contact_heading_above']) { echo esc_attr($options['contact_heading_above'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Subtitle above contact form', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[contact_heading_subtitle_above]" type="text" value="<?php if (isset($options['contact_heading_subtitle_above']) && $options['contact_heading_subtitle_above']) { echo esc_attr($options['contact_heading_subtitle_above'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Google Map', 'qode'); ?></td>
							<td>
								<select name="qode_options_stardust[enable_google_map]">
						...
						<tr valign="middle">
							...
							<td>	
								<div class="inline" style="width: 600px;">
								<input type="text" id="google_maps_pin_image" name="qode_options_stardust[google_maps_pin_image]" class="google_maps_pin_image" value="<?php if (isset($options['google_maps_pin_image'])) { echo esc_attr($options['google_maps_pin_image'], 'qode'); } else { echo QODE_ROOT."/img/pin.png"; } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<input id="google_maps_address" name="qode_options_stardust[google_maps_address]" value="<?php if (isset($options['google_maps_address'])) { echo esc_attr($options['google_maps_address'], 'qode'); } ?>" size="130" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map zoom', 'qode'); ?></td>
							<td>
								<input id="google_maps_zoom" name="qode_options_stardust[google_maps_zoom]" value="<?php if (isset($options['google_maps_zoom'])) { echo esc_attr($options['google_maps_zoom'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Google map height (px)', 'qode'); ?></td>
							<td>
								<input id="google_maps_height" name="qode_options_stardust[google_maps_height]" value="<?php if (isset($options['google_maps_height'])) { echo esc_attr($options['google_maps_height'], 'qode'); } ?>" size="10" maxlength="10" />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Disable Google map scroll on mouse wheel', 'qode'); ?></td>
							<td>
								<select name="qode_options_stardust[google_maps_scroll_wheel]">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Title', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[404_title]" type="text" value="<?php if ($options['404_title']) { echo esc_attr($options['404_title'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Subtitle', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[404_subtitle]" type="text" value="<?php if ($options['404_subtitle']) { echo esc_attr($options['404_subtitle'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Text', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[404_text]" type="text" value="<?php if ($options['404_text']) { echo esc_attr($options['404_text'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Back to home label', 'qode'); ?></td>
							<td>
								<input name="qode_options_stardust[404_backlabel]" type="text" value="<?php if ($options['404_backlabel']) { echo esc_attr($options['404_backlabel'], 'qode'); } ?>"  />
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_stardust[enable_social_share]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_stardust[enable_facebook_share]">
								...
								<div class="inline" style="width: 600px;">
									...
									<input type="text" id="facebook_icon" name="qode_options_stardust[facebook_icon]" class="facebook_icon" value="<?php if (isset($options['facebook_icon'])) { echo esc_attr($options['facebook_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_stardust[enable_twitter_share]">
								...
								<div class="inline" style="width: 600px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="twitter_icon" name="qode_options_stardust[twitter_icon]" class="twitter_icon" value="<?php if (isset($options['twitter_icon'])) { echo esc_attr($options['twitter_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<div class="inline">
									<?php esc_html_e('Via', 'qode'); ?>
									<input name="qode_options_stardust[twitter_via]" type="text" value="<?php if (isset($options['twitter_via'])) { echo esc_attr($options['twitter_via'], 'qode'); } ?>"  />
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_stardust[enable_google_plus]">
								...
								<div class="inline" style="width: 600px;">
									<?php esc_html_e('Share Icon', 'qode'); ?>
									<input type="text" id="google_plus_icon" name="qode_options_stardust[google_plus_icon]" class="google_plus_icon" value="<?php if (isset($options['google_plus_icon'])) { echo esc_attr($options['google_plus_icon'], 'qode'); } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<?php 
								...
								foreach ($post_types as $post_type ) {
									...
									?>
								 <input type="checkbox" value="<?php echo $post_type; ?>" <?php if (isset($options["post_types_names_$post_type"]) && ($options["post_types_names_$post_type"] == "$post_type")){ echo "checked='checked'"; }?> name="qode_options_stardust[post_types_names_<?php echo $post_type; ?>]" /><?php echo " " . $post_type_object->labels->singular_name;  ?><br /><br />
