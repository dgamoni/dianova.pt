		...
		*/
		var $customFields =	array(
			...
			array(
				...
				"title"			=> "Portfolio hover image",
				"description"	=> "",
				"type"			=> "portfolio-hover-image",
			...
			array(
				...
				"title"			=> "Portfolio background color",
				"description"	=> "",
				"type"			=> "colorpicker",
				"scope"			=>	array("portfolio_page"),
				"capability"	=> "manage_options"
			...
			array(
				"name"			=> "open-single-on-portfolio",
				"title"			=> "Open single portfolio on portfolio page",
				"description"	=> "",
				"type"			=> "selectbox-responsive-title-image",
				"scope"			=>	array("portfolio_page"),
				"capability"	=> "manage_options"
			...
			array(
				"name"			=> "color-title",
				"title"			=> "Choose color title variant",
				"description"	=> "",
				"type"			=> "selectbox-title-variant",
				"scope"			=>	array("page","post","portfolio_page"),
				"capability"	=> "manage_options"
			),
			array(
				"name"			=> "portfolio-single-color-variant",
				"title"			=> "Choose portfolio single color variant",
				"description"	=> "",
				"type"			=> "selectbox-title-variant",
				"scope"			=>	array("portfolio_page"),
				"capability"	=> "manage_options"
			...
			array(
				"name"			=> "full-width-padding",
				"title"			=> "Disable left/right padding for full width template",
				"description"	=> "",
				"type"			=> "selectbox-padding-full-width",
				"scope"			=>	array("page"),
				"capability"	=> "manage_options"
			),
		);
						...
						<div class="form-field form-required">
							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox-animation": {
									$page_transitions = "3";
									if (isset($qode_options_stardust['page_transitions'])) $page_transitions = $qode_options_stardust['page_transitions'];
								...
								case "selectbox-padding-full-width": {
									echo '<label for="' . $this->prefix . $customField[ 'name' ] .'" style="display:inline;"><b>' . $customField[ 'title' ] . '</b></label>&nbsp;&nbsp;';
									echo '<select name="' . $this->prefix . $customField[ 'name' ] . '" id="' . $this->prefix . $customField[ 'name' ] . '"> ';
									?>
										<option value="" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "" ) { ?> selected="selected" <?php } ?>></option>
								...
								case "portfolio-hover-image": {
									echo '<label for="' . $this->prefix . $customField[ 'name' ] .'" style="display:inline;"><b>' . $customField[ 'title' ] . '</b></label>&nbsp;&nbsp;';
									echo '<div class="image_holder"><input type="text" id="portfolio_hover_image" name="' . $this->prefix . $customField[ 'name' ] . '" class="portfolio_hover_image" value="'.htmlspecialchars( get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) ).'" /><input class="upload_button" type="button" value="Upload file"></div>';
									break;
								}
